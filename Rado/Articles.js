...
function fetchArticles() {
  ...
  while (hasNextPage) {
    ...
    try {
      ...
      edges.forEach(edge => {
        ...
        // Lagerbestand für erlaubte Lager summieren
  ...
  if (zeilen.length > 0) {
    // Textformate für Identifikatoren erzwingen
    sheet.getRange("A:D").setNumberFormat("@");

    // Werte auf einen Schlag schreiben
    ...
    // Sortierung nach Spalte H (WE_LiefDat / Spalte 8) aufsteigend
